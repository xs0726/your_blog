<template>
  <div class="bindGithub">
    <img class="bgImg" src="../../assets/home_top_bg.jpg" alt="" />
    <div class="bindGithub_container">
      <div class="title">
        <h1>登录以完成绑定</h1>
      </div>
      <div class="bindGithub_avatar">
        <div class="avatar1">
          <img class="avatar1_img" :src="githubInfo.url" alt="" />
        </div>
        <div class="line"></div>
        <div class="avatar2">
      ...
      <div class="bindGithub_tip">已有账号？输入账号信息登录立即绑定</div>
      <a-form
        :model="formState"
        name="basic"
...
const goRegister = () => {
  router.push({
    path: "register",
    query: { key: githubInfo.key, imgUrl: githubInfo.url },
  });
};
